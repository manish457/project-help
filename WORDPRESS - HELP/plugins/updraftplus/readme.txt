...
== Upgrade Notice ==
* 1.16.67: Fixes a non-persistent reflected XSS issue. Do not create a zip manifest file if the zip is still potentially incomplete. Fixes a potential issue with resumptions on large backups. Various small tweaks. A recommended update for all.
